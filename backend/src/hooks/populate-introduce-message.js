...
const introduceMessages = [
  `My name is Tam.`,
  `I'm a Fullstack Developer with 3 years of experiences in Web development.
   I speak HTML/CSS, React, Angular, Node and well versed in other libraries like Redux, Nestjs, and Loopback.
  ...
  `I love being part of a team, working in an agile environment, together toward a goal.
   ...
   You can check out my works at itsmetambui.netlify.sh .`,
